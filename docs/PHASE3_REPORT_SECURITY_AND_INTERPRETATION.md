...
3. Every analytical workbook includes a **Methodology & Limits** sheet explaining corroboration, identity, location, timestamp, data-quality, scoring and evidence-handling limitations.
